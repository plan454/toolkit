...
/**
   ...
   using the API.
   <p>
   Programmers must implement the {@link com.HttpHandler} interface. This interface
   ...
   represented by the {@link com.HttpExchange} class.
   The {@link com.HttpServer} class is used to listen for incoming TCP connections
   ...
   <p>
   The {@link com.HttpExchange} class encapsulates everything an application needs to
   process incoming requests and to generate appropriate responses.
   <p>
   Registering a handler with a HttpServer creates a {@link com.HttpContext} object and
   {@link com.Filter}
