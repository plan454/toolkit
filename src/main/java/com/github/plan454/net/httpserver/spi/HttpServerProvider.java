...
package com.github.plan454.net.httpserver.spi;
...
import com.github.plan454.exception.ServiceConfigurationError;
import com.github.plan454.net.httpserver.DefaultHttpServerProvider;
import com.github.plan454.net.httpserver.HttpServer;
import com.github.plan454.net.httpserver.HttpsServer;
...
public abstract class HttpServerProvider {
    ...
    private static boolean loadProviderFromProperty() {
        String cn = System.getProperty("com.github.plan454.net.httpserver.spi.HttpServerProvider");
        if (cn == null)
            return false;
        try {
     ...
     * <tt>com.HttpServerProvider</tt> is defined then it is
     ...
     * <tt>com.HttpServerProvider</tt> in the resource
